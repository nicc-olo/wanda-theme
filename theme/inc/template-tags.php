...
if ( ! function_exists( 'wanda_posted_on' ) ) :
	/**
...
if ( ! function_exists( 'wanda_posted_by' ) ) :
	/**
	 * Prints HTML with meta information about theme author.
	 */
	function wanda_posted_by() {
		printf(
...
if ( ! function_exists( 'wanda_comment_count' ) ) :
	/**
...
if ( ! function_exists( 'wanda_entry_meta' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 * This template tag is used in the entry header.
	 */
	function wanda_entry_meta() {
		...
		if ( 'post' === get_post_type() ) {
			...
			/* translators: used between list items, there is a space after the comma. */
			$tags_list = get_the_tag_list( '', __( ', ', 'wanda' ) );
			if ( $tags_list ) {
				printf(
...
if ( ! function_exists( 'wanda_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function wanda_entry_footer() {
...
if ( ! function_exists( 'wanda_comment_avatar' ) ) :
	/**
	 ...
	 */
	function wanda_get_user_avatar_markup( $id_or_email = null ) {

		if ( ! isset( $id_or_email ) ) {
			$id_or_email = get_current_user_id();
		}

		return sprintf( '<div class="vcard">%s</div>', get_avatar( $id_or_email, wanda_get_avatar_size() ) );
	}
endif;

if ( ! function_exists( 'wanda_discussion_avatars_list' ) ) :
	/**
	 * Displays a list of avatars involved in a discussion for a given post.
	 *
	 * @param array $comment_authors Comment authors to list as avatars.
	 */
	function wanda_discussion_avatars_list( $comment_authors ) {
		...
		foreach ( $comment_authors as $id_or_email ) {
			printf(
				"<li>%s</li>\n",
				wanda_get_user_avatar_markup( $id_or_email ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			);
		}
		echo '</ol>', "\n";
	}
...
if ( ! function_exists( 'wanda_the_posts_navigation' ) ) :
	/**
	 * Wraps `the_posts_pagination` for use throughout the theme.
	 */
	function wanda_the_posts_navigation() {
...
if ( ! function_exists( 'wanda_content_class' ) ) :
	/**
	 ...
	 * WANDA_TYPOGRAPHY_CLASSES constant.)
	 *
	 ...
	 */
	function wanda_content_class( $classes = '' ) {
		$all_classes = array( $classes, WANDA_TYPOGRAPHY_CLASSES );
